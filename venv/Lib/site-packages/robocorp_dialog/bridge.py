...
class Bridge:
    ...
    def __init__(
        ...
        self.elements: Elements = self._parse_elements(elements)
    ...
    def _parse_elements(self, elements: Elements) -> Elements:
        for element in elements:
            if element["type"] == "image":
                value = element["value"]
                element["value"] = self._load_image(value)

        return elements

    def _load_image(self, url_or_path: str) -> str:
        try:
